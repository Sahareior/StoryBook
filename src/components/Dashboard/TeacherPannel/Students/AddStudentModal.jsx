...
import { useAddStudentMutation } from "../../../../redux/api/authApi";
...
export default function AddStudentModal({ isOpen, onClose }) {
  ...
  const handleAddStudent = async (e) => {
    ...
    try {
      ...
      toast.error(
        err?.data?.error || err?.data?.message || "Failed to add student",
      );
    }
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="relative w-full max-w-6xl p-6 bg-white shadow-lg rounded-xl">
        ...
        {/* Content */}
        <form onSubmit={handleAddStudent} className="p-6 border rounded-xl">
